...
class DummyData {
  ...
  static final List<Course> dummyCourses = [
    Course(
      id: 'course1',
      title: 'Building Athletic Confidence',
      description: 'Develop unshakable confidence in your athletic abilities through proven psychological techniques',
      thumbnailUrl: 'https://picsum.photos/800/600?random=15',
      creatorId: 'coach1',
      creatorName: 'Dr. Michael Brown',
      creatorImageUrl: 'https://picsum.photos/200/200?random=10',
      tags: ['Beginner', 'All Sports', 'Self-Improvement'],
      focusAreas: [focusAreas[0], focusAreas[9]],
      durationMinutes: 53,
      xpReward: 100,
      modules: dummyModules1,
    ...
    Course(
      ...
      description: 'Learn practical techniques to transform pre-game anxiety into peak performance',
      thumbnailUrl: 'https://picsum.photos/800/600?random=16',
      creatorId: 'coach2',
      creatorName: 'Sarah Wilson',
      creatorImageUrl: 'https://picsum.photos/200/200?random=11',
      tags: ['Intermediate', 'Competition Focus', 'Mental Health'],
      focusAreas: [focusAreas[1], focusAreas[2]],
      durationMinutes: 57,
      xpReward: 120,
      modules: dummyModules2,
    ...
    Course(
      id: 'course3',
      title: 'Focus Training for Athletes',
      description: 'Master the art of concentration and eliminate distractions during competition',
      thumbnailUrl: 'https://picsum.photos/800/600?random=17',
      creatorId: 'coach1',
      creatorName: 'Dr. Michael Brown',
      creatorImageUrl: 'https://picsum.photos/200/200?random=10',
      tags: ['Advanced', 'Concentration', 'Elite Performance'],
      focusAreas: [focusAreas[3], focusAreas[9]],
      durationMinutes: 65,
      xpReward: 150,
      modules: dummyModules1,
    ...
    Course(
      ...
      description: 'Help your team bounce back from setbacks and build mental toughness',
      thumbnailUrl: 'https://picsum.photos/800/600?random=18',
      creatorId: 'coach2',
      creatorName: 'Sarah Wilson',
      creatorImageUrl: 'https://picsum.photos/200/200?random=11',
      tags: ['Team Sports', 'Leadership', 'Resilience'],
      focusAreas: [focusAreas[5], focusAreas[6], focusAreas[7]],
      durationMinutes: 70,
      xpReward: 130,
      modules: dummyModules2,
    ...
    Course(
      ...
      description: 'Develop a powerful pre-competition routine to ensure peak mental performance',
      thumbnailUrl: 'https://picsum.photos/800/600?random=19',
      creatorId: 'coach1',
      creatorName: 'Dr. Michael Brown',
      creatorImageUrl: 'https://picsum.photos/200/200?random=10',
      tags: ['All Levels', 'Competition Focus', 'Routines'],
      focusAreas: [focusAreas[2], focusAreas[10]],
      durationMinutes: 50,
      xpReward: 100,
      modules: dummyModules1,
    ...
    Course(
      id: 'course6',
      title: 'Championship Mindset Development',
      description: 'Exclusive course for university athletes on developing a championship mindset',
      thumbnailUrl: 'https://picsum.photos/800/600?random=20',
      creatorId: 'coach3',
      creatorName: 'Coach James Davis',
      creatorImageUrl: 'https://picsum.photos/200/200?random=12',
      tags: ['Advanced', 'Elite', 'University'],
      focusAreas: [focusAreas[7], focusAreas[9], focusAreas[10]],
      durationMinutes: 85,
      xpReward: 200,
      modules: dummyModules2,
  ...
  static final List<DailyAudio> dummyAudioModules = [
    DailyAudio(
      ...
      imageUrl: 'assets/images/audio/morning.jpg',
      creatorId: 'coach1',
      creatorName: 'Dr. Michael Brown',
      durationMinutes: 10,
    ...
    DailyAudio(
      ...
      imageUrl: 'assets/images/audio/pregame.jpg',
      creatorId: 'coach2',
      creatorName: 'Sarah Wilson',
      durationMinutes: 15,
      focusAreas: [focusAreas[1], focusAreas[2]],
    ...
    DailyAudio(
      ...
      imageUrl: 'assets/images/audio/focus.jpg',
      creatorId: 'coach1',
      creatorName: 'Dr. Michael Brown',
      durationMinutes: 12,
    ...
    DailyAudio(
      ...
      imageUrl: 'assets/images/audio/motivation.jpg',
      creatorId: 'coach2',
      creatorName: 'Sarah Wilson',
      durationMinutes: 10,
    ...
    DailyAudio(
      ...
      imageUrl: 'assets/images/audio/resilience.jpg',
      creatorId: 'coach1',
      creatorName: 'Dr. Michael Brown',
      durationMinutes: 15,
    ...
    DailyAudio(
      ...
      imageUrl: 'assets/images/audio/team.jpg',
      creatorId: 'coach2',
      creatorName: 'Sarah Wilson',
      durationMinutes: 12,
    ...
    DailyAudio(
      ...
      imageUrl: 'assets/images/audio/leadership.jpg',
      creatorId: 'coach3',
      creatorName: 'Coach James Davis',
      durationMinutes: 15,
    ...
    DailyAudio(
      ...
      imageUrl: 'assets/images/audio/gameday.jpg',
      creatorId: 'coach3',
      creatorName: 'Coach James Davis',
      durationMinutes: 20,
    ...
    DailyAudio(
      ...
      imageUrl: 'assets/images/audio/today.jpg',
      creatorId: 'coach1',
      creatorName: 'Dr. Michael Brown',
      durationMinutes: 10,
      focusAreas: [focusAreas[3]],
